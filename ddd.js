...
function formSuccess(){
    $("#contactForm")[0].reset();
    $(".contact-form-success-message-with-border").delay(499).fadeOut();
...
$("#form-show").click(function(){
    ...
    $("#ContactForm1_contact-form-submit").removeClass("height-zero");
    $(".tab_info").slideUp(1000);
    $(".contact-form-success-message-with-border").removeClass("hidden").hide().slideDown(1200);
